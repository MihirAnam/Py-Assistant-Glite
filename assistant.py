        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    name=soup.find(class_='aMEhee PZPZlf').get_text()
                    status=soup.find(class_='WlRRw IsqQVc fw-price-dn').get_text()
                    details=soup.find(class_='zz63rd').get_text()

                    result=name+str(price)+str(status)+str(details)
                    return result
                    ...
                    try:
                        price=soup.find(class_='IsqQVc NprOob wT3VGc').get_text()
                        name=soup.find(class_='aMEhee PZPZlf').get_text()
                        status=soup.find(class_='WlRRw IsqQVc fw-price-up').get_text()
                        details=soup.find(class_='V30e3e XGnM2 knowledge-finance-wholepage-chart__fw-uch').get_text()
